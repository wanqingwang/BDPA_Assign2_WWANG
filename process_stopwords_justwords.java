...
public class process_stopwords_justwords extends Configured implements Tool {

	private static final Logger LOG = Logger
			.getLogger(process_stopwords_justwords.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new process_stopwords_justwords(), args);
		System.exit(res);
	}
